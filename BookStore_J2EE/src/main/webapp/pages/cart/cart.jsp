	...
	<div id="main">
		...
		<table>
			...
			<tr>
				...
				<td><a class="deleteClass" href="cartServlet?action=deleteItem&id=${book.id}">删除</a></td>
			</tr>
			</c:forEach>
		...
		<div class="cart_info">
			...
			<span class="cart_span"><a class="emptyClass" href="cartServlet?action=clear">清空购物车</a></span>
